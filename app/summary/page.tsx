  ...
  return (
    <div style={{ minHeight: "100vh", background: t.bg, color: t.text, fontFamily: "'Syne','Outfit',sans-serif" }}>
      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "28px 20px 90px" }}>
        <p style={{ fontSize: 11, letterSpacing: 2, textTransform: "uppercase", color: t.accent, fontWeight: 700 }}>End of day</p>
        <h1 style={{ fontSize: 26, fontWeight: 800, margin: "8px 0 6px" }}>Today on Pulse</h1>
        <p style={{ fontSize: 13, color: t.muted, marginBottom: 22 }}>AI brief of today’s news, takes, and markets. Open to anyone.</p>
        ...
        {data && (
          <div style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: 14, padding: 22 }}>
            <div style={{ fontSize: 11, color: t.muted, marginBottom: 8 }}>{data.date} · {data.count} cards</div>
